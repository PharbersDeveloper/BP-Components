...
import layout from '../../templates/components/bp-dropdown/menu';
...
export default Component.extend({
	...
	popperPlacement: computed('direction', 'align', function () {
		let placement = 'bottom-start',
			{ direction, align } = this.getProperties('direction', 'align');
	 ...
	 * @private
	 */
	itemComponent: 'bp-dropdown/menu/item',
	 ...
	 * @private
	 */
	linkToComponent: 'bp-dropdown/menu/link-to',
	 ...
	 * @private
	 */
	dividerComponent: 'bp-dropdown/menu/divider',
	optionComponent: 'bp-dropdown/menu/option'
});
